...
const Mood = () => {
  ...
  return (
    <div className={`min-h-screen w-full flex items-center justify-center bg-mooody-yellow text-mooody-green overflow-hidden transition-opacity duration-2000 ease-in-out ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
      <LanguageToggle />
      <Button
