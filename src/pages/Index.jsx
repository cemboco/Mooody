          ...
          <>
            <div className="animated-title w-full h-full flex flex-col items-center justify-between">
              <div className="flex-grow flex items-center justify-center flex-col">
                ...
                <p className="text-xl sm:text-2xl md:text-3xl mt-4 text-center max-w-2xl opacity-0 animate-fade-in-more-delayed relative z-10 font-hevilla" style={{ marginTop: '-7rem' }}>
                  Weil, <span className="font-hevilla underline">"wie geht's?"</span> oft nicht ausreicht.
                </p>
              </div>
