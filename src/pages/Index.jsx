    ...
    <div className="h-screen w-full bg-[#FFF8E7] text-[#2D3748] overflow-hidden relative flex flex-col">
      ...
      <div className="flex-grow flex flex-col justify-center items-center px-4 relative">
        <div className="text-center relative z-10 max-w-4xl mx-auto">
          ...
          <p className="mt-3 text-sm text-gray-600">{t.tryForFree || 'Try for free - No Credit Card Required'}</p>
        </div>
      </div>
      <div className="absolute bottom-0 left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full" style={{ height: '15vh' }}>
