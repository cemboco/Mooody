  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-mooody-yellow text-mooody-green overflow-hidden">
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <a href="https://www.producthunt.com/posts/mooody-space?embed=true&utm_source=badge-featured&utm_medium=badge&utm_souce=badge-mooody&#0045;space" target="_blank" rel="noopener noreferrer">
          <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=489379&theme=light" alt="Mooody&#0046;Space - Track&#0032;Your&#0032;Emotions&#0044;&#0032;and&#0032;Find&#0032;Balance&#0032;with&#0032;Mooody&#0046; | Product Hunt" style={{ width: '250px', height: '54px' }} width="250" height="54" />
        </a>
      </div>
    </div>
  );
