export const translations = {
  ...
  en: {
    ...
    initialMoodQuestion: 'Notice something that bothers you. It can be a feeling in your body or a specific thought in your head. For the sake of this exercise, let\'s call your annoying problem "stress". Now rate the intensity on a scale of 0-10 (where 10 represents the highest stress level). How intense is this particular stress?',
